...
namespace MetaMomentum.Composers
{
    public class MetaMomentumApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Meta Momentum Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<MetaMomentumOperationSecurityFilter>();
            });
        }

        public class MetaMomentumOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("MetaMomentum.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
