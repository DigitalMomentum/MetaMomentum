...
export default class MetaMomentumPropertyEditorUIElement extends UmbLitElement implements UmbPropertyEditorUiElement {
  ...
  public value: MetaValue | undefined;
 ...
 */
  ...
  #onUpdateMetaValue(e: InputEvent) {
    ...
    this.value = { ...this.value, ...{ [property]: source.value } };
   ...
   */
    async #onShareImageChanged(newShareImageValue: string | undefined) {
      ...
      let newValue : MetaValue|undefined = {
          ...this.value,
          ...{
              share : {
                  ...this.value?.share,
    ...
    return html`
          <umb-stack look="compact">
            ...
            >
              <uui-textarea
                slot="editor"
                .value=${this.value.shareDescription}
                @input=${this.#onUpdateMetaValue}
                data-bind="shareDescription"
                rows="2"
                style="width:100%;"
              ></uui-textarea>
            </umb-property-layout>
